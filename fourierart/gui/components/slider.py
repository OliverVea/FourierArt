...
class CustomSlider(QGroupBox):
    def __init__(self, title, parameter: Parameter, callback = Nop, interpolator: str = 'lin', interpolator_order: float = 50, input_width: int = 80):
        super().__init__()
    ...
    def on_input_change(self):
        ...
        self.set_input_text(self.p.get())
